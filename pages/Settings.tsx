    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <Card className="p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-3">
             <Button variant="outline" className="flex-1" icon={ExternalLink} onClick={() => window.open('https://supabase.com/dashboard', '_blank')}>
                Dashboard
             </Button>
             <Button className="flex-1" icon={Save} onClick={handleSaveSupabase}>
                Salvar
             </Button>
          </div>
        </div>
      ...
      <Card className="p-6">
         ...
         <div className="space-y-4">
            ...
            <Button variant="secondary" className="w-full">Validar Conexão</Button>
            <Button variant="outline" className="w-full" icon={ExternalLink} onClick={() => window.open('https://dashboard.vapi.ai', '_blank')}>Painel VAPI</Button>
            <Button className="w-full" icon={Save} onClick={handleSaveVapi} disabled={saving}>
